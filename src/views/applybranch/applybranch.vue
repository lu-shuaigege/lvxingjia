<template>
    <div class="applybranch">
        ...
        <div class="center">
            <div class="center-item">
                ...
                >
                    <img
                        class="img"
                        v-show="this.positive == ''"
                        src="@/assets/img/my/sfzzm.png"
                        alt
                    />
                    <img
                        class="img"
                        v-show="this.positive != ''"
                        :src="headimgurl + this.fileimg"
                        alt
                    />
                    <div class="center-tittle">身份证正面</div>
                    <van-button type="primary" class="uploadbutton"
                        >拍照/上传照片</van-button
                    >
                </van-uploader>
            </div>
            <div class="center-item">
                ...
                <van-uploader
                    v-model="back"
                    :after-read="upLoadcard1"
                    :max-count="1"
                >
                    <img
                        class="img"
                        v-show="this.back == ''"
                        src="@/assets/img/my/sfzfm.png"
                        alt
                    />
                    <img
                        class="img"
                        v-show="this.back != ''"
                        :src="headimgurl + this.fileimg1"
                        alt
                    />
                    <div class="center-tittle">身份证反面</div>
                    <van-button
                        class="center-button uploadbutton"
                        type="primary"
                        >拍照/上传照片</van-button
                    >
                </van-uploader>
        ...
        <div class="agreement">
            ...
            <div
                :class="checkboxa == false ? 'read' : 'readactive'"
                @click="agreementwordfn()"
            >
...
export default {
    ...
    methods: {
        ...
        echo() {
            this.$api.settled_in.show(3).then(res => {
                this.type = res.type;
                this.name = res.name;
                this.mobile = res.mobile;
                this.id_card = res.id_card;
                this.fileimg = res.positive;
                this.fileimg1 = res.back;
                this.fileimg2 = res.business_license;
                this.bank = res.bank;
        ...
        submitauditfn: function() {
            ...
            this.business_license = this.headimgurl + this.fileimg2;
            if (
                this.checkboxa != 0 &&
                this.type &&
                this.name != "" &&
