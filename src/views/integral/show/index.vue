    ...
    <div class="linedetails">
        ...
        <!-- <yd-slider class="banners" autoplay="3000">
            <yd-slider-item v-for="(item, index) in banners" :key="index">
                <img class="banner_img" :src="imgAfterUrl + item" />
            </yd-slider-item>
        </yd-slider>-->
        <div class="banners">
            <img class="banner_img" :src="imgAfterUrl + banners" />
        </div>
        <!-- 内容区 -->
        <div class="content">
            <!-- 最上面主要信息 -->
            <div class="top">
                ...
                <div class="money">
                    <div class="money-left">
                        <div class="moneysp2">￥{{ data.price }}</div>
                    </div>
                    <div class="money-right">
                        <div class="moneysp3">{{ data.expend }}</div>
                        <div class="moneysp4">积分</div>
                    </div>
                </div>
            </div>
            <!-- 商品介绍 -->
            ...
            <div
                class="buy"
                @click="buyfn(data.id,data.cover_img,data.name,data.desc,data.expend)"
            >立即兑换</div>
        </div>
