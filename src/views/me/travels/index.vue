    ...
    <div class="mytravels">
        <div class="domesticlist">
            ...
            <van-list
                ...
                @load="onLoad"
            >
                <div class="item" v-for="(item, indexg) in myexchangelist" :key="indexg">
                    <div class="domestictop">
                        <div class="top">
                            ...
                            <div class="shu"></div>
                            <div
                                @click="routerLink('/travels/create', {id: item.id})"
                                class="edit"
                            >编辑</div>
                        </div>
                    ...
                    <div class="domestic-bottom">
                        ...
                        <div class="bottom-bototm">
                            <div class="date">发表于&nbsp;&nbsp;{{ item.created_at }}</div>
                            <div class="like">
        ...
        <div @click="routerLink('/travels/create')" class="addbtn">新建一篇游记</div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        del(id) {
            this.$api.travelnotes.del(id).then(res => {
                this.$toast("删除游记成功");
                location.reload();
            });
        }
