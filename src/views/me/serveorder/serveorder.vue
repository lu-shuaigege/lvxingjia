        ...
        <div class="order-content">
            ...
            >
                <div
                    ...
                    @click="routerLink('serveorder_show', { id: item.id })"
                >
                    <div class="item-top">
                    ...
                    <div class="item-center">
                        ...
                        <div class="item-center-right">
                            ...
                            <div
                                class="num"
                                v-show="item.obj.prices.price_num != null"
                            >
...
export default {
    ...
    created() {
        ...
        //获取全部的订单
        this.$api.service_orders.index().then(res => {
    ...
    methods: {
        onLoad() {
            this.$api.service_orders
                .index(this.topbtnactive, this.page)
                .then(res => {
                    this.page++;
                    this.loading = false;
